...
import { Monitor, Moon, RefreshCw, X } from 'lucide-react-native';
...
export function SettingsModal({ visible, onClose }: SettingsModalProps) {
  ...
  return (
    <Modal visible={visible} animationType="slide" presentationStyle="fullScreen" statusBarTranslucent={true} onRequestClose={onClose}>
      <View style={[styles.container, { backgroundColor: t.bg }]}>
        {/* Header */}
        <View style={[styles.header, { borderBottomColor: t.border, backgroundColor: t.bgCard, paddingTop: insets.top + 10 }]}>
          <Text style={[styles.headerTitle, { color: t.text }]}>Einstellungen</Text>
          <TouchableOpacity onPress={onClose} style={[styles.closeBtn, { backgroundColor: t.bgSubtle }]}>
        ...
        {showResetConfirm && (
          <View style={[StyleSheet.absoluteFill, styles.overlay, { backgroundColor: t.isDark ? 'rgba(17,20,24,0.98)' : 'rgba(245,247,250,0.98)' }]}>
